...
def getDwnURL(os: str = OS,
              arch: str = ARCH,
              mode: int = 1) -> str:
    lurl = [f'https://cdn.azul.com/zulu/bin/zulu17.38.21-ca-jre17.0.5-{os}_{arch}.zip',
...
def main():
    ...
    if os.system('java --version') != 0:
        ...
        command = f'./.data/{_filename}/bin/java -jar .data/{_efilename}/{_efilename}.jar'
    else: 
